...
button_simplify = tk.Button(bottom_frame, text='Simplify', command=lambda: add_image(calc.simplify))
button_simplify.grid(row=0, column=3)
button_approx = tk.Button(bottom_frame, text='Approx', command=lambda: add_image(calc.approx))
button_approx.grid(row=0, column=4)
button_solve = tk.Button(bottom_frame, text='Solve', command=lambda: add_image(calc.solve))
button_solve.grid(row=0, column=5)
button_graph = tk.Button(bottom_frame, text='Graph', command=lambda: add_image(printter=calc.print_plot))
button_graph.grid(row=0, column=6)
